...
do -- legit
    local aim = legit:section({name = "Aim Assist", scroll = true}) do
        ...
        aim:slider({name = "Field Of View (Â°)", flag = "aim fov", min = 0, max = 360, default = 30}) 
        ...
        aim:toggle({name = "Deadzone (Â°)", flag = "aim dead"}):slider({flag = "aim dead amount", min = 0, max = 360, default = 5})
    end
    ...
    local legitbox = legit:multisection({side = "right"}) do 
        ...
        local silent = legitbox:tab({name = "Silent Aim"}) do
            ...
            silent:slider({name = "Field Of View (Â°)", flag = "silent fov", min = 0, max = 360, default = 30}) 
...
do -- visuals
    ...
    local camera = visuals:section({name = "Camera", size = UDim2.new(1, 0, 1, -280)}) do
        camera:toggle({name = "Field Of View (Â°)", flag = "camera fov"}):slider({flag = "camera fov amount", min = 1, max = 120, default = 90})
...
do -- misc
    ...
    local desync = misc:section({name = "Client Desync", side = "right", size = UDim2.new(1, 0, 0, 200), scroll = true}) do
        ...
        desync:slider({name = "Pitch (Â°)", flag = "desync pitch", min = -180, max = 180, default = 0})
        desync:slider({name = "Yaw (Â°)", flag = "desync yaw", min = -180, max = 180, default = 0})
        desync:slider({name = "Roll (Â°)", flag = "desync roll", min = -180, max = 180, default = 0})
